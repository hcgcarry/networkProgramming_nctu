...
public:
    clientSession(serverInfo serverInfoObj, tcp::socket socket_, tcp::endpoint endpoint_) : serverInfoObj(std::move(serverInfoObj)), socket_(std::move(socket_)), endpoint_(std::move(endpoint_))
    {
